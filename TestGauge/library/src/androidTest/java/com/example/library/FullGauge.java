...
public class FullGauge extends com.ekndev.gaugelibrary.AbstractGauge {
    ...
    protected Paint getRangePaintForValue(double value, List<com.ekndev.gaugelibrary.Range> ranges) {
    ...
    protected void drawValueArcOnCanvas(Canvas canvas, RectF rectF, float startAngle, float sweepAngle, double value, List<com.ekndev.gaugelibrary.Range> ranges) {
        prepareCanvas(canvas);
