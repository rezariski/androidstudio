...
abstract class AbstractGauge extends View {
    ...
    private List<com.ekndev.gaugelibrary.Range> ranges = new ArrayList<>();
    ...
    private ValueFormatter formatter = new com.ekndev.gaugelibrary.ValueFormatterImpl();
    ...
    public void addRange(com.ekndev.gaugelibrary.Range range) {
        if (range == null)
            return;
        ranges.add(range);
    }
    ...
    public List<com.ekndev.gaugelibrary.Range> getRanges() {
        return ranges;
    }

    public void setRanges(List<com.ekndev.gaugelibrary.Range> ranges) {
        this.ranges = ranges;
    }
    ...
    protected int getRangeColorForValue(double value, List<com.ekndev.gaugelibrary.Range> ranges) {
    ...
    protected String getFormattedValue(double value) {
        ...
        if (formatted == null)
            return new com.ekndev.gaugelibrary.ValueFormatterImpl().getFormattedValue(value);
        return formatted;
    }
