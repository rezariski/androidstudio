...
public class MultiGauge extends FullGauge {
    ...
    private List<com.ekndev.gaugelibrary.Range> secondRanges = new ArrayList<>();
    private List<com.ekndev.gaugelibrary.Range> thirdRanges = new ArrayList<>();
    ...
    private Paint getRangePaint(double value, List<com.ekndev.gaugelibrary.Range> ranges) {
        ...
        for (com.ekndev.gaugelibrary.Range range : ranges) {
    ...
    public void addSecondRange(com.ekndev.gaugelibrary.Range range) {
        this.secondRanges.add(range);
    }

    public void addThirdRange(com.ekndev.gaugelibrary.Range range) {
        this.thirdRanges.add(range);
    }

    public List<com.ekndev.gaugelibrary.Range> getSecondRanges() {
        return secondRanges;
    }

    public void setSeconRanges(List<com.ekndev.gaugelibrary.Range> secondRanges) {
        this.secondRanges = secondRanges;
    }

    public List<com.ekndev.gaugelibrary.Range> getThirdRanges() {
        return thirdRanges;
    }

    public void setThirdRanges(List<com.ekndev.gaugelibrary.Range> thirdRanges) {
